...
def run():
    ...
    if(actionNum == '1'):
        ...
        print("生成中..")
        getSQL([1,2,3,4,6,7,8,9,10,11,12,13,14,16,17,18,19,20],'active',timing)
        ##abcs = [1,2,4,5,7,8]
        ##for abc in abcs:
        ##    getSQL([abc])
    elif actionNum == '4':
